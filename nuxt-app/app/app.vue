...
<template>
    ...
    <div class="font-barlow flex flex-col bg-[#151110] p-[10vw] pb-[20rem] justify-between w-[100%]">
        <div class="flex flex-row gap-[1rem] justify-center -mt-[20rem]">
            <color color="linear-gradient(90deg,rgba(184, 134, 11, 1) 0%, rgba(204, 170, 106, 1) 49%, rgba(184, 134, 11, 1) 100%);" name="Desert Gold" desc="PVD-Gold, limitierte Edition"/>
            <div class="w-[1px] bg-[#656565]"></div>
            <color color="linear-gradient(90deg,rgba(145, 145, 145, 1) 1%, rgba(219, 219, 219, 1) 49%, rgba(133, 133, 133, 1) 100%);" name="Titan Silber" desc="Klassiche Eleganz, maximal leicht"/>
            <div class="w-[1px] bg-[#656565]"></div>        
            <color color="linear-gradient(90deg,rgba(20, 20, 20, 1) 1%, rgba(51, 51, 51, 1) 49%, rgba(20, 20, 20, 1) 100%);" name="Space Black" desc="DLC-beschichtetes Titan, tiefschwarz"/>
        </div>
    </div>
    <!--CTA-->
    ...
    <div class="items-center flex flex-col font-barlow bg-[#151110] pb-[10rem] ">
        <div class="text-[#656565] text-[1.1rem] flex flex-row gap-[0.5rem] items-center">
            <div>Ab 899€</div>
        ...
        <div class="text-[3rem] font-black mt-[1rem] text-center">
            <div class="text-white">Deine Zeit.</div>
            <div class="text-[#F27127] text-[3.5rem] -mt-[1rem]">Deine Uhr.</div>
        </div>
        <div class="flex flex-row gap-[1rem] mt-[2rem]">
